...
class foosball:
    ...
    def __init__(self, debug=False):
        ...
        self.dim = {
            ...
            'foosballHSVLower': (15, 20, 20),       # Foosball lower bound (HSV)
            'foosballHSVUpper': (25, 255, 255),     # Foosball upper bound (HSV)
    ...
    def updateDisplay(self, images):
        ...
        cv2.putText(self.output, "FPS: %s".format(self.fps), (1020, mvHeight - 5), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 1)
